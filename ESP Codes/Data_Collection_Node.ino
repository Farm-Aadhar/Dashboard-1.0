...
void setup() {
  Serial.begin(115200);
  Serial.println("\nBooting ESP32 Data Collection Node...");
...
void handleRoot() {
  ...
  html += "<title>Farm Aadhar Data Collection Node</title><meta http-equiv=\"refresh\" content=\"5\">";
  ...
  html += "</head><body><div class=\"container\"><h1>Farm Aadhar Data Collection Node</h1>";
...
void updateLCDDisplay() {
  if (millis() - lastDisplaySwitchMillis >= displayCycleInterval) {
    currentDisplayScreen = (currentDisplayScreen + 1) % 2; // Display screens for data collection node
